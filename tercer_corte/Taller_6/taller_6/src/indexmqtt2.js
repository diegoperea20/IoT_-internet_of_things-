...
const connection = mysql.createPool({
  ...
  database: "datosproyecto",//nombre del LA BASE DE DATOS CREADA en mysql 
  port: 3307,
});
...
client.on("message", function (topic, message) {
  ...
  connection.getConnection(function (error, tempConn) {
    ...
    if (error) {
      ...
      console.log("Conexion correcta.");//tempConn.query( "INSERT INTO  *nombre de la TABLA*  VALUES(null, ?, ?,?,?)"
      tempConn.query(
